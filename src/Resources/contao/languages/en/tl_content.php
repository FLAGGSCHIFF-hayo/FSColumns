...
$GLOBALS['TL_LANG']['tl_content']['third'] = 'Third';
$GLOBALS['TL_LANG']['tl_content']['quarter'] = 'Quarter';
$GLOBALS['TL_LANG']['tl_content']['two-third'] = 'Two-Thirds';
$GLOBALS['TL_LANG']['tl_content']['three-quarter'] = 'Three-Quarters';
$GLOBALS['TL_LANG']['tl_content']['colBackground'] = array('Background','Do you wish to add a background to this column?');
$GLOBALS['TL_LANG']['tl_content']['colFullwidthBg'] = array('Full width','Do you wish for this element to be the horizontal size of the browser viewport?');
$GLOBALS['TL_LANG']['tl_content']['colBgColor'] = array('Backgroundcolour','Choose the backgroundcolour of this element');
$GLOBALS['TL_LANG']['tl_content']['info_screensizes'] = 'Preview screen sizes';

$GLOBALS['TL_LANG']['CTE']['colStart'] = array("Wrapper start","");
